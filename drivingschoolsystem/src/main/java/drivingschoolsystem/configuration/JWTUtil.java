...
public class JWTUtil {
    ...
    private static final long REFRESH_EXPIRATION_TIME = 604800000;  // 7 μέρες
    ...
    public String generateRefreshToken(UserDetails userDetails) {
        return Jwts.builder()
                .subject(userDetails.getUsername())
                .issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis() + REFRESH_EXPIRATION_TIME)) // Μεγαλύτερη διάρκεια
                .signWith(Key)
                .compact();
    }
